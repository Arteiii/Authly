...
<section>
		...
		<header class="absolute inset-x-0 top-0 z-50">
			<nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
				...
				<div class="hidden lg:flex lg:flex-1 lg:justify-end">
					<a href="/auth/login/" class="text-sm font-semibold leading-6 text-gray-900 dark:text-gray-100"
			...
			<div class="lg:hidden" role="dialog" aria-modal="true">
				...
				<div
					class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 dark:bg-slate-900"
				>
					...
					<div class="mt-6 flow-root">
						<div class="-my-6 divide-y divide-gray-500/10">
							...
							<div class="py-6" data-sveltekit-preload-data="hover">
								<a
									href="/auth/login/"
		...
		<div class="relative isolate px-6 pt-14 lg:px-8">
			...
			<div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
				<div class="hidden sm:mb-8 sm:flex sm:justify-center">
					<div
						class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20 dark:text-gray-300"
					>
	...
	<div class="overflow-hidden bg-white py-24 sm:py-32 dark:bg-slate-900">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      <div class="lg:pr-8 lg:pt-4">
        <div class="lg:max-w-lg">
          <h2 class="text-base font-semibold leading-7 text-indigo-600">Deploy faster</h2>
          <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-gray-200">A better workflow</p>
          <p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.</p>
          <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none dark:text-gray-300">
